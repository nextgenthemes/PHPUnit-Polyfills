...
use Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectNoReturnType;
use Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectUnionNoReturnType;
...
final class AssertObjectEqualsPHPUnitLt940Test extends TestCase {
	...
	public function testAssertObjectEqualsFailsOnMethodNotDeclared() {
		$msg = 'Comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectNoReturnType::doesNotExist() does not exist.';
	...
	public function testAssertObjectEqualsFailsOnMethodAllowsForMoreParams() {
		$msg = 'Comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectNoReturnType::equalsTwoParams() does not declare exactly one parameter.';
	...
	public function testAssertObjectEqualsFailsOnMethodParamNotRequired() {
		$msg = 'Comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectNoReturnType::equalsParamNotRequired() does not declare exactly one parameter.';
	...
	public function testAssertObjectEqualsFailsOnMethodParamMissingTypeDeclaration() {
		$msg = 'Parameter of comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectNoReturnType::equalsParamNoType() does not have a declared type.';
	...
	public function testAssertObjectEqualsFailsOnMethodParamHasUnionTypeDeclaration() {
		$msg = 'Parameter of comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectUnionNoReturnType::equalsParamUnionType() does not have a declared type.';
	...
	public function testAssertObjectEqualsFailsOnMethodParamNonClassTypeDeclaration() {
		$msg = 'is not an accepted argument type for comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectNoReturnType::equalsParamNonClassType().';
		if ( \PHP_VERSION_ID < 70000 ) {
			$msg = 'Parameter of comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectNoReturnType::equalsParamNonClassType() does not have a declared type.';
		}
	...
	public function testAssertObjectEqualsFailsOnMethodParamNonExistentClassTypeDeclaration() {
		$msg = 'is not an accepted argument type for comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectNoReturnType::equalsParamNonExistentClassType().';
	...
	public function testAssertObjectEqualsFailsOnMethodParamTypeMismatch() {
		$msg = 'is not an accepted argument type for comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectNoReturnType::equals().';
	...
	public function testAssertObjectEqualsFailsOnNonBooleanReturnValue() {
		$msg = 'Comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectNoReturnType::equalsNonBooleanReturnType() does not return a boolean value.';
