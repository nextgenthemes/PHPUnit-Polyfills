...
use Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ChildValueObject;
use Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObject;
use Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectUnion;
 ...
 *
 * The `AssertObjectEqualsPHPUnitLt930Test` class mirrors this test class
...
final class AssertObjectEqualsTest extends TestCase {
	...
	public function testAssertObjectEqualsFailsOnMethodNotDeclared() {
		$msg = 'Comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObject::doesNotExist() does not exist.';
	...
	public function testAssertObjectEqualsFailsOnMethodAllowsForMoreParams() {
		$msg = 'Comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObject::equalsTwoParams() does not declare exactly one parameter.';
	...
	public function testAssertObjectEqualsFailsOnMethodParamNotRequired() {
		$msg = 'Comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObject::equalsParamNotRequired() does not declare exactly one parameter.';
	...
	public function testAssertObjectEqualsFailsOnMethodParamMissingTypeDeclaration() {
		$msg = 'Parameter of comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObject::equalsParamNoType() does not have a declared type.';
	...
	public function testAssertObjectEqualsFailsOnMethodParamHasUnionTypeDeclaration() {
		$msg = 'Parameter of comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectUnion::equalsParamUnionType() does not have a declared type.';
	...
	public function testAssertObjectEqualsFailsOnMethodParamNonClassTypeDeclaration() {
		$msg = 'is not an accepted argument type for comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObject::equalsParamNonClassType().';
	...
	public function testAssertObjectEqualsFailsOnMethodParamNonExistentClassTypeDeclaration() {
		$msg = 'is not an accepted argument type for comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObject::equalsParamNonExistentClassType().';
	...
	public function testAssertObjectEqualsFailsOnMethodParamTypeMismatch() {
		$msg = 'is not an accepted argument type for comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObject::equals().';
	...
	public function testAssertObjectEqualsFailsOnNonBooleanReturnValue() {
		$msg = 'Comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObject::equalsNonBooleanReturnType() does not return a boolean value.';

		$exception = self::COMPARATOR_EXCEPTION;
		if ( \class_exists( ComparisonMethodDoesNotDeclareBoolReturnTypeException::class ) ) {
			// PHPUnit > 9.4.0.
			$msg       = 'Comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObject::equalsNonBooleanReturnType() does not declare bool return type.';
